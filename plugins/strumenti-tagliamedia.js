...
➤ *Rispondendo ad un audio o video*`);
        ...
        let inputPath = join(__dirname, '../tmp/', `input_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`);
        let outputPath = join(__dirname, '../tmp/', `output_${Date.now()}_${Math.random().toString(36).substr(2, 9)}${ext}`);
